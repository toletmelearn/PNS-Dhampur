...
<body>
    @foreach($admitCardsData as $admitCard)
    <div class="admit-card">
        ...
        @if(isset($admitCard['qr_code']) && $admitCard['qr_code'])
        <div class="qr-section">
            <img src="{{ $admitCard['qr_code'] }}" alt="QR Code" />
        </div>
        @endif
        ...
        <div class="exam-details">
            ...
            <div style="display: table; width: 100%;">
                <div style="display: table-cell; width: 50%;">
                    <strong>Subject:</strong> {{ $admitCard['exam_subject'] }}<br>
                    <strong>Date:</strong> {{ \Carbon\Carbon::parse($admitCard['exam_date'])->format('d/m/Y') }}<br>
                    <strong>Day:</strong> {{ \Carbon\Carbon::parse($admitCard['exam_date'])->format('l') }}
                </div>
                <div style="display: table-cell; width: 50%;">
                    <strong>Time:</strong> {{ $admitCard['exam_time'] }}<br>
                    <strong>Duration:</strong> {{ $admitCard['exam_duration'] }}<br>
